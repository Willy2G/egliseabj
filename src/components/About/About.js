    ...
    <section className="flex items-center lg:py-16 py-4 bg-stone-100  font-poppins dark:bg-gray-800 z-0">
      <div className="justify-center flex-1 w-full lg:mx-16 py-4 mx-auto lg:py-6 md:px-6">
        <div className="flex flex-wrap ">
          ...
          <div className="w-full px-4 mb-10 lg:w-1/2 lg:mb-0 ">
            <h2 class="text-black font-bold text-4xl uppercase relative h-auto w-full pb-1 text-center xl:text-left ">
              A propos <span class="text-red-500">.</span>
            </h2>
            ...
            <Typography color="gray" className="mb-8 mt-3 font-normal">
              Sans prétention aucune, ce site se veut une courroie, un canal, un
              véhicule pour prolonger ce que Dieu fait par Ses serviteurs sur
              terre dans notre temps...
            </Typography>
            ...
            <Typography color="gray" className="mb-8 mt-3 font-normal">
              ...
              précédente vous proposait... Tout y est gratuit car... ce que vous
              avez reçu gratuitement, donnez-le gratuitement.
            </Typography>
